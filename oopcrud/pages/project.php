<?php
	...
	if(isset($_POST['btnSubmit'])){
		...
		if($objProject->hasil){
			echo '<script> window.location = "dashboardadmin.php?
			p=projectlist";</script>';
		}
	}
...
<div class="container">
	<div class="col-md-6">
		<h4 class="title"><span class="text"><strong>Project</strong></span></h4>
		<form action="" method="post">
			<table class="table" border="0">
				<tr>
					...
					control" name="pnumber" value="<?php echo $objProject->pnumber; ?>">
				...
				<tr>
					...
					<td><input type="text" class="form-
					control" name="pname" value="<?php echo $objProject->pname; ?>">
